...
[DeepSeek](https://chat.deepseek.com/)，在 IDEA 安装 Continue 插件，从 [DeepSeek API Keys](https://platform.deepseek.com/api_keys) 获取 api keys

https://hf-mirror.com/

Linux 部署 deepseek-r1
