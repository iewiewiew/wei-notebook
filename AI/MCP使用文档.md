...
[Cursor](https://cursor.sh/)，[MCP 配置](完整AI工作流配置/cursor/mcp.json)，系统路径：[~/.cursor/mcp.json]( ~/.cursor/mcp.json)，MCP 配置地址：https://docs.cursor.com/tools/mcp
...
代码目录：/Users/menghuawei/workspace/my-project/gitee-data-generator
