...
[Cloudflare 简介](https://www.cloudflare.com/zh-cn/about-overview/)

Cloudflare Workers 是 Cloudflare 的边缘计算平台，让你的代码跑在 Cloudflare 遍布全球 300+ 个数据中心，而不是某个固定的服务器。用户的请求在离他们最近的节点直接被处理，延迟极低。  
Cloudflare 是一家全球领先的云网络和安全公司，主要为网站、应用及企业网络提供加速、安全防护和优化服务。作为网站与访客之间的“中间人”（反向代理），它通过全球庞大的内容分发网络（CDN）提供DDoS攻击防御、WAF防火墙、DNS解析等功能，使网络服务更快速、安全。
...
修改 next.config.ts 配置

在 package.json 配置构建命令
```
