...
![img](./images/JMeter+InfluxDB+Grafana.png)
...
![img](./images/Grafana+InfluxDB配置.png)
...
![img](./images/Grafana+InfluxDB配置2.png)
...
![img](./images/JMeter模板.png)

**JMeter 仪表盘**

![img](./images/JMeter仪表盘.png)
...
![img](./images/Prometheus数据源.png)

### 2.2 Node-Exporter

Node-Exporter 页面访问地址：http://127.0.0.1:9100/metrics

![img](./images/Node-Exporter页面.png)
