...
![img](../images/postman/postman-workspace.png)

Postman 登录后本地数据会和远程数据同步，如果未登录则无法导入文件（踩坑点）。

![img](../images/postman/postman-import.png)
...
![img](../images/postman/postman-demo.png)
...
![img](../images/postman/postman-import-curl.png)

导出接口：选择 Collections 的集合右键选择 Export 进行导出。

![img](../images/postman/postman-export.png)

### 环境变量

设置环境变量：在 Enviroments 添加环境变量，可配置多组环境变量，在请求时右上角进行切换组变量。

![img](../images/postman/postman-variable.png)
...
![img](../images/postman/postman-random-varialble.png)
...
![img](../images/postman/postman-use-varibable.png)

读取文件内容为变量：点击集合【...】，选择【Run Collection】，设置 Iterations，选择文件，在请求里面引用变量（文件表头），例如 {{name}}。


![img](../images/postman/postman-file.png)
