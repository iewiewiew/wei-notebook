...
-- 插入数据
INSERT INTO "public"."tabledemo" ("id", "name", "age", "remark") VALUES (1, '张三', '18', '11');
INSERT INTO "public"."tabledemo" ("id", "name", "age", "remark") VALUES (2, '李四', '18', '11');

-- 更新数据
UPDATE "public"."tabledemo" SET "name" = '张三', "age" = '18', "remark" = '11' WHERE "id" = 1;
UPDATE "public"."tabledemo" SET "name" = '李四', "age" = '18', "remark" = '11' WHERE "id" = 2;
